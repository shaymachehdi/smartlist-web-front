@isset($value)
<div class="modal fade" id="{{$value->title}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
@endif
                <form action="{{url('/updateGroup/'.$value->idGroup)}}" method="post">
